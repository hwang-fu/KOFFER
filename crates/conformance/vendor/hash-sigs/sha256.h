...
#define USE_OPENSSL 0   /* KOFFER: changed from upstream 1 -- use the bundled  */
                        /* portable SHA-256 below, not OpenSSL, so the harness  */
                        /* builds with no external C library dependency.        */
